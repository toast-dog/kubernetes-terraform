...
cert_manager_version = "v1.20.3"  # renovate: datasource=docker depName=quay.io/jetstack/charts/cert-manager

traefik_version          = "41.0.2"  # renovate: datasource=helm registryUrl=https://traefik.github.io/charts depName=traefik
